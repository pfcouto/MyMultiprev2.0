...
object Constants {
    ...
    // Alarm
    const val NOTIFICATIONS_DRUG_NAME = "NOTIFICATIONS_DRUG_NAME"
    const val NOTIFICATIONS_ALARM_ID = "NOTIFICATIONS_ALARM_ID"
    const val NOTIFICATIONS_ALARM_INSTANT = "NOTIFICATIONS_ALARM_INSTANT"
